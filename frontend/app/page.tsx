        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0 ml-auto">
            ...
            <Link href="/auth/register">
              <Button variant="primary" size={scrolled ? "sm" : "md"} rightIcon={<ArrowRight className="h-4 w-4" />} className="transition-all shadow-md text-xs sm:text-sm px-2 sm:px-4">
                Register
              </Button>
            </Link>
            <button
        ...
        <div className="relative w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 pb-12 sm:pb-20 pt-6 sm:pt-10 text-center flex flex-col items-center p-2.5">
          ...
          >
            <Link href="/auth/register" className="w-full sm:w-auto">
              <Button size="lg" rightIcon={<ArrowRight className="h-4 w-4 sm:h-5 sm:w-5" />} className="px-4 sm:px-8 w-full sm:w-auto shadow-lg shadow-primary-500/25 hover:shadow-xl hover:-translate-y-0.5 transition-all text-sm sm:text-base">
                Get Started Free
              </Button>
            </Link>
          ...
          >
            {features.map((feature, i) => (
              <motion.div
                ...
                custom={i}
                whileHover={{ y: -4 }}
                className="group flex flex-col items-center text-center p-4 sm:p-6 lg:p-8 rounded-2xl sm:rounded-3xl bg-surface border border-border/60 hover:shadow-xl hover:shadow-primary-500/5 transition-all duration-300"
              >
                <div className={`w-10 h-10 sm:w-14 sm:h-14 mx-auto rounded-xl sm:rounded-2xl bg-gradient-to-br ${feature.color} flex items-center justify-center text-white mb-3 sm:mb-6 group-hover:scale-110 group-hover:rotate-[-5deg] transition-transform duration-500 shadow-md text-lg sm:text-2xl`}>
                  {feature.icon}
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full sm:w-auto">
                  <Link href="/auth/register" className="w-full sm:w-auto">
                    <Button
                      variant="secondary"
                      size="lg"
                      className="bg-white text-primary-700 hover:bg-white/90 shadow-xl px-4 sm:px-8 py-3 text-sm sm:text-base hover:-translate-y-0.5 transition-all w-full sm:w-auto"
                  ...
                  <Link href="/auth/login" className="w-full sm:w-auto">
                    <Button
                      variant="outline"
                      size="lg"
                      className="border-white/40 text-white hover:bg-white/10 hover:border-white/70 px-4 sm:px-8 py-3 text-sm sm:text-base hover:-translate-y-0.5 transition-all w-full sm:w-auto"
                    >
                      Admin Login
                    </Button>
                  </Link>
