...
async function lookupWardFromCoords(lat: number, lng: number): Promise<GeolocationResult> {
    ...
    const wards: { minLat: number; maxLat: number; minLng: number; maxLng: number; ward: string; name: string }[] = [
        { minLat: 28.45, maxLat: 28.47, minLng: 77.02, maxLng: 77.04, ward: "Ward 12", name: "Sector 12 — Noida" },
        { minLat: 28.47, maxLat: 28.49, minLng: 77.00, maxLng: 77.02, ward: "Ward 5", name: "Sector 5 — Greater Noida" },
        { minLat: 28.60, maxLat: 28.65, minLng: 77.20, maxLng: 77.25, ward: "Ward 3", name: "Connaught Place — Delhi" },
        { minLat: 28.55, maxLat: 28.60, minLng: 77.18, maxLng: 77.22, ward: "Ward 8", name: "Lodhi Colony — Delhi" },
        { minLat: 28.70, maxLat: 28.75, minLng: 77.10, maxLng: 77.15, ward: "Ward 15", name: "Pitampura — Delhi" },
        { minLat: 28.63, maxLat: 28.68, minLng: 77.05, maxLng: 77.12, ward: "Ward 1", name: "Dwarka — Delhi" },
    ];
